...
import { BsCurrencyDollar, BsSuitDiamond, BsSuitDiamondFill } from 'react-icons/bs'
...
const ProductFilters = ({
  ...
  return (
    <section className='col-span-1 w-full h-fit bg-surface py-4 px-2 md:px-4 2xl:px-8 rounded-2xl hidden lg:block overflow-hidden'>
      <CategoriesBox
        filter={filter}
        setFilter={setFilter}
      />
