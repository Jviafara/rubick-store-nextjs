...
const OrderList = ({ max }: { max?: number }) => {
  ...
  return (
    <section className='w-full flex flex-col items-center space-y-4 overflow-visible'>
      <div className='w-full flex items-center mb-8 gap-8'>
        ...
        {max && (
          <div className='border border-primary text-xs sm:text-sm rounded-2xl bg-muted/20 h-fit py-2 px-4 hover:scale-105 text-nowrap'>
