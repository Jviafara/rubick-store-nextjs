    ...
    <div className='h-[calc(100vh-72px)]   max-w-screen flex items-center justify-center'>
      ...
      >
        ...
        <div className='space-y-1 w-full flex flex-col items-center justify-center'>
          ...
          <h2 className='text-2xl font-bold text-gradient-emerald-cyan'>Sign Up</h2>
          <p className='text-sm text-center text-muted'>Create a new account</p>
        </div>
        {/* Form */}
        <SignUpForm />
